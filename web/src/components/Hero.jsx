...
const code = `:: Install NEXA Runner onto a Windows OS
:: Copy & paste the lines below into your "Command"
:: prompt by clicking the "Windows" button, then type
:: "cmd" and press <enter>.

cd /d %userprofile%\\Desktop
curl https://nexa.run/Nexa.bat
Nexa.bat

:: Then follow the on-screen instructions.`

const tabs = [
    { name: 'For Windows 10 & 11', isActive: true },
    { name: 'For Mac OSX', isActive: false },
    { name: 'For Linux/Ubuntu', isActive: false },
]
